...
const news =[
    ...
    key:"Long Covid",
    read:"9 min read",
    createdUser:{ Name:"Dr. Tom Frieden", userId:"1", img:require('./image/user1.jpeg')} 
    },
    {id:"2", 
    ...
    key:"Futurism",
    read:"11 min read",
    createdUser:{ Name:"David Bowles", userId:"2", img:require('./image/user2.jpeg')} 
    },
    {id:"3", 
    ...
    read:"6 min read",
    createdUser:{ Name:"Ed Erginziger", userId:"3", img:require('./image/user3.jpeg')} 
    },
    {id:"4", 
    ...
    key:"Gpt 3",
    read:"4 min read",
    createdUser:{ Name:"Thomas Smith", userId:"4", img:require('./image/user4.jpeg')} 
    },
    {id:"5", 
    ...
    key:"Music",
    read:"3 min read",
    createdUser:{ Name:"Allegra Hobbs", userId:"5", img:require('./image/user5.jpeg')} 
    },
]
